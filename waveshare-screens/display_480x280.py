"""
Waveshare E-ink Display Firmware - 480x280
3.7" Model (4-level Grayscale: White/Light Gray/Dark Gray/Black)

Runs on Raspberry Pi Pico W. Receives image data via HTTP POST
and displays it on the connected e-ink screen.

Color Modes:
  - B&W only:   16,800 bytes (1 bit per pixel)
  - Grayscale:  33,600 bytes (2 bits per pixel, 4 levels)
