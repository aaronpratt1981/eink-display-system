"""
Generic E-ink Display Receiver - 264x176
For Waveshare 2.7" displays (4-level grayscale)

Auto-detects B&W vs Grayscale based on data size!
- B&W mode: 5,808 bytes (1 bit per pixel)
- Grayscale mode: 11,616 bytes (2 bits per pixel, 4 levels)
"""
